# Contributing to `buffr-core`

Thanks for considering a contribution. `buffr-core` is pre-1.0 and the public
...
```bash
git clone git@github.com:kryptic-sh/buffr-core.git
cd buffr-core
